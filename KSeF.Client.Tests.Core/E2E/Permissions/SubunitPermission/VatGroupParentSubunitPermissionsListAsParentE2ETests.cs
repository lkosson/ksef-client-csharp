...
/// 6) Cofnięcie nadanych uprawnienień i sprzątnięcie danych testowych
/// </summary>
public class VatGroupParentSubunitPermissionsListAsParentE2ETests : TestBase
{
    ...
    public async Task SubunitAdmins_AsVatGroupParent_ShouldReturnList()
    {
        ...
        // Arrange: nadanie jednostce podrzędnej uprawnień SubunitManage i CredentialsManage w jej kontekście
        ...
        // Act: nadanie uprawnienia administratora jednostki podrzędnej (w kontekście jednostki podrzędnej)
        ...
        // Assert: lista uprawnień nie jest pusta i zawiera oczekiwany wpis
    ...
    /// <returns>Access token w kontekście jednostki podrzędnej.</returns>
    ...
    /// <summary>
    /// Nadaje uprawnienie administratora jednostki podrzędnej w kontekście jednostki podrzędnej.
    /// </summary>
    ...
    /// <summary>
    /// Cofnięcie wskazanych uprawnień i wypollowanie statusów aż do uzyskania powodzenia.
    /// </summary>
