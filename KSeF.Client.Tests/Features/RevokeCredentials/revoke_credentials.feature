...
@smoke
Scenariusz: W³aœciciel odbiera uprawnienie wystawiania faktur
Zak³adaj¹c, ¿e uwierzytelni³em siê jako w³aœciciel
Oraz na kontekœcie zosta³o nadane uprawnienie wystawiania faktur dla identyfikatora
Kiedy odbiorê to uprawnienie
Wtedy nie powinno ju¿ byæ aktywne dla tego identyfikatora.
